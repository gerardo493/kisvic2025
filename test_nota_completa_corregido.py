...
# -*- coding: utf-8 -*-
"""
Script de prueba CORREGIDO para demostrar el flujo de notas de entrega.
...
def entregar_nota(nota):
    ...
    if guardar_datos(ARCHIVO_NOTAS_ENTREGA, notas):
        ...
        print(f"❌ Error guardando cambios de entrega")
        return False
...
def procesar_pago_completo(nota):
    ...
    if guardar_datos(ARCHIVO_INVENTARIO, inventario):
        ...
        print(f"❌ Error guardando inventario")
        return False
    ...
    if nota['numero'] in notas:
        ...
        for i, producto_id in enumerate(productos):
            ...
            if producto_id in inventario:
                ...
                print(f"   ❌ {producto_id}: Producto no encontrado en inventario")

def main():
    """Función principal del script de demostración completa."""
    print("🚀 DEMOSTRACIÓN COMPLETA DEL FLUJO DE NOTAS DE ENTREGA (CORREGIDA)")
    print("="*80)
